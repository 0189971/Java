...
/**
 * Librerias para que trabaje el sistema
 */
 ...
 * The rest of it:
 *
 * Copyright 1996, Brian C. Jepson (bjepson@ids.net)
 *
 * $Author: davis $
 ...
 * to statement which created it. If the resultset was not created by an 
 * statement, <code>null</code> is returned (f.i. used in 
...
public class tinySQLResultSet implements java.sql.ResultSet {
    ...
    /**
     * The Prepared Statement that created this resultset
     */
    private tinySQLPreparedStatement preparedStatement =
            (tinySQLPreparedStatement)null;
    /**
     * The tsResultSet
     */
     ...
     */
    public tinySQLResultSet( tsResultSet res, 
        tinySQLStatement inputStatement ) {
        result = res;
        this.statement = inputStatement;
    }
    /**
     * Crea un objeto con un conjunto de resultados y una sentencia preparada
     * 
     * @param res el conjunto de resultados
     * @param inputStatement la sentencia prepàrada
     */
    public tinySQLResultSet( tsResultSet res, 
        tinySQLPreparedStatement inputStatement ) {
        result = res;
    ...
    public synchronized boolean next() throws SQLException {
        try {
            ...
            String deDonde = "tinySQLResultSet.next() :\n";
            throw new SQLException( deDonde + " " + e.getMessage() );
        }
    }
    /**
     *
    ...
    public boolean getBoolean(int column) throws SQLException {
        try {
            ...
            String deDonde = "tinySQLResultSet.getBoolean() :\n";
            throw new SQLException( deDonde + " " + e.getMessage());
        }
    }
    /**
    ...
    public short getShort( int column ) throws SQLException {
        ...
        try {
            ...
            String deDonde = "tinySQLResultSet.getShort() :\n";
            throw new SQLException( deDonde +
                " tinySQL invalid short Number: " + e.getMessage( ));
        }
    }  
    /**
     *
    ...
    public int getInt( int column ) throws SQLException {
        ...
        try {
            ...
            String deDonde = "tinySQLResultSet.getint() :\n";
  ...
  public long getLong( int column ) throws SQLException {
    ...
    try
    {
      return Long.valueOf( str.trim( )).longValue( );
        ...
        String deDonde = "tinySQLResultSet.getLong() :\n";
        throw new SQLException( deDonde + 
            " tinySQL invalid Long Number: " + e.getMessage() );
    }
  }  
     ...
     throws SQLException
  {
    ...
    {
        String deDonde = "tinySQLResultSet.getFloat() :\n";
        throw new SQLException( deDonde + 
    ...
    throws SQLException
  {
    ...
    {
        String deDonde = "tinySQLResultSet.getDouble() :\n";
        throw new SQLException( deDonde + 
            " tinySQL invalid double Number: " + e.getMessage( ));
    }
  }  
  /**
   *
  ...
  public byte[] getBytes(int column) throws SQLException {
    ...
    try {
      return str.getBytes(str);
        ...
        String deDonde = "tinySQLResultSet.getBytes() :\n";
        throw new java.sql.SQLException( deDonde + 
            " Bad bytes!: " + e.getMessage());
    }
       ...
       throws SQLException 
  {
    ...
    try {
      ...
      return new java.sql.Date(d.getTime());
        ...
        String deDonde = "tinySQLResultSet.getDate() :\n";
      throw new SQLException( deDonde + 
  ...
  public java.sql.Time getTime(int column)
    ...
    try {
      ...
      return new java.sql.Time(d.getTime());
        ...
        String deDonde = "tinySQLResultSet.getTime() :\n";
        throw new SQLException( deDonde + 
  ...
  public java.sql.Timestamp getTimestamp(int column)
    ...
    try {
      ...
      return new java.sql.Timestamp(d.getTime());
        ...
        String deDonde = "tinySQLResultSet.getTimestamp() :\n";
        throw new SQLException( deDonde + 
                " Data format error: " + e.getMessage());
    }
   ...
   * @param scale precision for BigDecimals
  ...
  public void clearWarnings() throws SQLException {
    ...
    * if the driver does not support national
     ...
     * A <code>ResultSet</code> is closed if the method close has been called 
     ...
     * It is intended for use when updating <code>NCHAR</code>, 
