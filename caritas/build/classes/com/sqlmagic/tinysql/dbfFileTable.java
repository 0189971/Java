 ...
 * JDK 2 support
 * @author Thomas Morgner <mgs@sherito.org> Added caching for the current read 
 * row. A row is now read only once and substrings are generated by each call 
 * to getCol. Incredibly increased read speed when little memory is available 
 * and disks are slow.
...
public class dbfFileTable extends tinySQLTable {
    ...
    /**
     * Cabecera del archivo dBase los primeros 32 bytes del archiivo
     */
     ...
     *  '*': is deleted
     */
    final static int IS_DELETED_INDEX = 0;    
    /**
     * La tupla es borrada, ' ': is not deleted
     */                                  
    final static char RECORD_IS_DELETED = '*';
    /**
     * Cuando la tupla no se almacena
     */
     ...
     */
    public dbfFileTable( String dDir, String table_name ) 
     ...
     * 
     * @return true si esta abierto y false en caso contrario
     */
    @Override
    ...
    public void close() throws tinySQLException {
        try {
            ...
            String deDonde = "dbfFileTable.close() :\n";
     ...
     * 
     * @return devuelve el numero de tuplas
     */
    @Override
     ...
     * @exception tinySQLException la excepcion que se propaga
     * 
     * @return devuelve el decimal que toma la columna
     */
    @Override
    ...
    public int colType( String colName ) throws tinySQLException {
        System.out.println( "COLUMNASSSSS: " + colName );
        tsColumn coldef = getColumn(colName);
        return coldef.type;
    }
    /**
     ...
     * @exception tinySQLException la excepcion que se propaga
     * 
     * @return devuelve un objeto tsColumn
     */
    public tsColumn getColumn( String colName ) throws tinySQLException {
        ...
        System.out.println( " INDICE PUNTO: " + foundDot );
        if ( foundDot > -1 ) {
     ...
     * @exception tinySQLException la excepcion que se propaga
     */
    public void updateCurrentRow( Vector c, Vector v ) 
        throws tinySQLException {
        /*
 ...
 */
         ...
         String deDonde = "dbfFileTable.insertRow() :\n";
         throw new tinySQLException( deDonde + " " + e.getMessage() );
      }
      if (c != null && v != null) {
 ...
 */
   public static String getColumn (tsColumn coldef, String row)
   {
     ...
     * @param dbfHeader cabecera del archivo dbf
     * @param currentRow the wanted record (starts with 1)
     * see tinySQLTable#getCol
     *
     ...
     * 
     * @exception tinySQLException lanza la excepcion
     */
    public static String _GetCol( RandomAccessFile ff, DBFHeader dbfHeader,
        ...
        try {
             ...
             */
            ff.seek( dbfHeader.headerLength + (currentRow - 1) * 
                     dbfHeader.recordLength );
            /*
             * Fully read a byte array out to the length of the record and 
            ...
            String deDonde = "dbfFileTable._GetCol() :\n";
            throw new tinySQLException( deDonde + " " + e.getMessage() );
        }
    }
    /**
     ...
     */
    @Override
    public void updateCol( String colName, String value ) 
        throws tinySQLException {
         ...
         */
         ftbl.seek( dbfHeader.headerLength + (currentRecordNumber - 1) * 
                    dbfHeader.recordLength + column.position );
        /*
         * Enforce the correct column length, transform to byte and write to 
         * file
         */
         ...
         dbfHeader.setTimestamp(ftbl);
          ...
          String deDonde = "dbfFileTable.updateCol() :\n";
         throw new tinySQLException( deDonde + " " + e.getMessage() );
      }
   }
    /**
    ...
    public void deleteRow() throws tinySQLException {
        try {
            ...
            String deDonde = "dbfFileTable.deleteRow() :\n";
            throw new tinySQLException( deDonde + " " + e.getMessage() );
        }
    }
    /**
     ...
     * 
     * @return devuelve true si es borrada y false en caso contrario
     */
    @Override
     ...
     * 
     * @param ff el archivo de bases de datos
     * @param dbfHeader la cabecera del archivo de datos
     * @param currentRow fila actual
     * 
     * @return devuelve true si la tupla fue borrada
     */
    public static boolean isDeleted( RandomAccessFile ff, DBFHeader dbfHeader, 
        int currentRow ) throws tinySQLException {
     ...
     * 
     * @param record the record string (the first byte '*' marks a deleted 
     * record)
     */
     ...
     * 
     * @return el estado del objeto en cadena
     */
    @Override
    public String toString() {
        StringBuffer outputBuffer;
        outputBuffer = new StringBuffer();
        outputBuffer.append( "Table " ).append( table ).append( ", path "
            ).append( fullPath ).append( ", file " ).append( ftbl.toString() ); 
     ...
     * 
     * @return devuelve la tabla hash
     */
    public Hashtable openDbf() throws tinySQLException {
        try {
            ...
            if( !f.exists() ) {
                throw new tinySQLException ( "Unable to open " +
                    f.getAbsolutePath() 
            ...
            String deDonde = "dbfFileTable.openDbf() :\n";
            throw new tinySQLException( deDonde + " " + e.getMessage() );
        }
    }
}
