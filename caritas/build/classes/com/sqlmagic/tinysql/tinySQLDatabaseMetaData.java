...
public class tinySQLDatabaseMetaData implements java.sql.DatabaseMetaData {
    ...
    /**
     * Crea el objeto de consulta de meta datos
     * 
     * @param connection la conexion para hacer la tarea
     */
    ...
    /**
     * Devuelve las funciones de la columna
     * 
     * @param catalog el catalogo
     * @param schemaPattern el patron del esquema
     * @param functionNamePattern el nombre de la funcion del patron
     * @param columnNamePattern el nombre de la columna patron
     * 
     ...
     * 
     * @param catalog el catalogo
     * @param schemaPattern el esquema patron
     * @param functionNamePattern el nombre de la funcion patron
     * 
     * @return devuelve el conjunto de resultados
     * 
    ...
    /**
     * Devuelve el estado SQL del tipo
     * 
     * @return devuelve un entero indicando el estado
     * 
     * @throws SQLException por si ocurre un error
     */
    @Override
    ...
    /**
     * Pregunta si es soportado
     * 
     * @param holdability la retension
     * 
     * @return devuelve false si no se soporta y true en caso contrario
     * 
     * @throws SQLException por si ocurre un error
     */
    @Override
    ...
    /**
     * Crea el conjunto de resultados
     * 
     * @param catalog el catalogo
     * @param schemaPattern el esquema del patron
     * @param typeNamePattern el nombre del patron
     * @param attributeNamePattern  el atributo del patron
     * 
     * @return devuelve el conjunto de resultados
     * 
     * @throws SQLException la excepcion que maneja
     */
    @Override
     ...
     * 
     * @param iface el objeto por el que se pregunta
     * 
    ...
    /**
     * Deselvuelve un objeto
     * 
     * @param <T> el objeto que se deselvuelve
     * @param iface el objeto que se desenvuelve
     * 
     * @return devuelve el objeto desenvuelto
     * 
     * @throws java.sql.SQLException por si ocurre un error
     */
    @Override
