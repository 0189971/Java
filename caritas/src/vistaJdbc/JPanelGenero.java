...
/*
 * Created by JFormDesigner on Fri Nov 15 18:39:45 CST 2013
 */
...
public class JPanelGenero extends JPanel {
	...
	private void initComponents() {
		...
		//======== panel1 ========
		{
			panel1.setBorder(new TitledBorder(new BevelBorder(BevelBorder.RAISED), "Genero"));
			...
			//---- label3 ----
			label3.setText("Nombre del genero");
			panel1.add(label3);
