 ...
 *
 * @author Thomas Morgner <mgs@sherito.org> Changed tsResultSet to support 
 * java.sql.Types, a custom fetchsize, and storing a state for unfinished 
 * queries.
      ...
      if (dbengine != null)
      {
	    ...
	    dbengine.contSelectStatement (this); 
	       ...
	       return eof;
             ...
             String deDonde = "tsResultSet.getMoreResults() :\n";
