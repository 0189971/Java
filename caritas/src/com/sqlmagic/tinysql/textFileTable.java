 ...
 * Changed column types to java.sql.types.
 */
public class textFileTable extends tinySQLTable {
  ...
  long record_length;     // length of a record
     ...
     *
     */
    public textFileTable( String dDir, String table_name ) 
        ...
        try {
          ftbl = new RandomAccessFile(dataDir + "/" + table_name, "rw");
            ...
            String deDonde = "textFileTable.textFileTable() :\n";
            throw new tinySQLException( deDonde + 
                " Could not open the file " + table + ".");
        }
        // read in the table definition
        readColumnInfo();
    }
    /**
     * Devuelve el numero de columnas (No implementada para archivos de texto)
     * 
     * @return devuelve el numero de tuplas contenidas en la tabla
     */
    @Override
    ...
    public void close() throws tinySQLException {
        try {
            ...
            String deDonde = "textFileTable.close() :\n";
  ...
  public void updateCurrentRow( Vector c, Vector v ) throws tinySQLException {
    ...
    public void goTop() throws tinySQLException {
        try {
            ...
            String deDonde = "textFileTable.goTop() :\n";
            throw new tinySQLException( deDonde + " " + e.getMessage() );
        }
    ...
    if (record_number > 0) {
      ...
      try {
        ftbl.seek( ftbl.getFilePointer() + record_length + 1);
          ...
          String deDonde = "textFileTable.nextRecord() :\n";
  ...
  public void insertRow( Vector c, Vector v ) throws tinySQLException {
    try {
      ...
      ftbl.seek( ftbl.getFilePointer() - (record_length + 1) );
        ...
        String deDonde = "textFileTable.insertRow() :\n";
        throw new tinySQLException( deDonde + " " + e.getMessage());
    }
    if (c != null && v != null) {
  ...
  public String getCol(String column) throws tinySQLException {
    ...
    try {
      ...
      if (datatype.equals("NUMERIC")) {
        ...
        String deDonde = "textFileTable.getCol() :\n";
        throw new tinySQLException( deDonde + " " + e.getMessage() );
    }
  }
  ...
  public void updateCol( String column, String value ) throws tinySQLException {
    ...
    try {
      ...
      ftbl.seek( ftbl.getFilePointer() - (pos + (long) writeval.length()) );
        ...
        String deDonde = "textFileTable.updateCol() :\n";
            System.out.println( deDonde + " " + e.getMessage() );
      e.printStackTrace();
   ...
   *
   */
  public void readColumnInfo() throws tinySQLException {
    try {
      ...
      fdef.close(); // close the file
        ...
        String deDonde = "textFileTable.readColumnInfo() :\n";
        throw new tinySQLException( deDonde + " " + e.getMessage() );
    }
  }
}
