...
class tsColumn implements Cloneable {
    ...
    /**
     * Nombre de los argumentos de la funcion
     */
    String functionArgString = (String)null;  // Function arguments
    /**
     * Funciones argumentos como columnas
     */
     ...
     * @exception tinySQLException por si ocurre un error
     */
    public tsColumn( String string ) throws tinySQLException {
        this(string,(Hashtable)null,"SELECT");
    }
    /**
     * The constructor creates a column object using recursion if this is a 
     * function.
     * 
     * @param s la cadena
     * @param tableDefs la definicion de la tabla
     * @param inputContext el contexto de entrada
     * @exception tinySQLException por si ocurre un error
     */
    public tsColumn( String s, Hashtable tableDefs,String inputContext )
 ...
 */
   ...
   public boolean clear(String inputTableName)
   {
     ...
     * @param inputColumnValue el valor de la columna
     * 
     * @throws tinySQLException por si ocurre un error
     */
    public void update(String inputColumnName,String inputColumnValue)
        throws tinySQLException {
      int i;
      tsColumn argColumn;
      if ( isConstant | inputColumnName == (String)null ) { 
          return;
        }
      if ( inputColumnName.trim().length() == 0 ) { 
          return;
        }
      if ( functionName == (String)null )
      {
 ...
 */
            ...
            if ( inputColumnValue.trim().length() == 0 ) { 
                return;
                }
            notNull = true;
            if ( type == Types.CHAR | type == Types.DATE | type == -1 )
            {
               ...
               try
               {
                  intValue = Integer.parseInt(inputColumnValue.trim()); 
                    ...
                    String deDonde = "tinySQLWhere.update() :\n";
                    System.out.println( deDonde + " " + ex.getMessage() );
 ...
 */
     ...
     * 
     * @throws tinySQLException por si ocurre una excepcion
     */
 ...
 */
                  ...
                  stringValue = yearField + "-" + monthField + "-" + dayField; 
                   ...
                   String deDonde = "tinySQLWhere.updateFunctions() :\n";
                    System.out.println( deDonde + " " + dayEx.getMessage() );
 ...
 */
   ...
   /**
    * Compara con un objeto igual
    * 
    * @param inputObj el objeto que se compara
    * 
 ...
 */
   public boolean getContext(String inputContext)
   {
     ...
     * devuelve el objeto
     * 
     * @return devuelve el estado del objeto
     */
