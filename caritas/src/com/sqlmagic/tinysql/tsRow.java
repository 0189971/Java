 ...
 *
 */
public class tsRow extends Hashtable implements Comparable {
    /**
     * Se ordena mediante columnas
     */
    private Vector orderByColumns = (Vector)null;
    /**
     ...
     *
     * @param inputColumns the name of the column
     *
     */
    ...
    /**
     * Pone la columna como una cadena de tipo String
     * 
     ...
     *
     * @return devuelve la columna como un String
     */
    public String columnAsString( tsColumn column ) {
        ...
        if ( ft1.countFields() == 2 ) {
           ...
           outputString = functionBuffer.toString();
            ...
            /*
             * This is a constant.  Return the table name which will be equal 
           ...
           if ( Utils.isDateColumn(column.type) ) 
           {
              ...
              try {
                 outputString = UtilString.toStandardDate(outputString);
                  ...
                  String deDonde = "tsRow.columnAsString() :\n";
                  System.out.println( deDonde + " " + dateEx.getMessage());
              }  
           }
        }
        return outputString;
   ...
   /**
    * Compara contra otro objeto tsRow
    * 
    * @param inputObj el objeto que se compara
    * 
    * @return devuelve 0 si es null, 1 si es mayor y -1 si es menor
    */
    @Override
    ...
    * 
    * @return devuelve el estado detsRow
    */
    @Override
